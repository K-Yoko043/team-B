            ...
            <table class="table table-striped" v-if="contents">
                ...
                >
                    <h3 class="card-header">
                        ...
                        {{ content.user_name }}
                        <i
                            v-if="content.user_name === own.name"
                            class="far fa-edit clickable"
                    ...
                    <div class="card-footer btn-group" role="group">
                        ...
                        <button
                            class="btn btn-outline-info btn-sm ml-10"
                            @click="onComment(content)"
                        >
                            <i class="far fa-lg fa-comment-dots"></i>
                            コメントする
                        </button>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        async getItems() {
            ...
            axios.all([api.get("/api/goriller")]).then(
